...
namespace Antmicro.Renode.Peripherals.GPIOPort
{
    ...
    public class RpGpioBase : BaseGPIOPort, IRP2040Peripheral, IDoubleWordPeripheral, IGPIOReceiver, IKnownSize
    {
        public RpGpioBase(IMachine machine, int numberOfPins, int numberOfCores, ulong address) : base(machine, numberOfPins)
        {
            ...
            pinMapping = RpGpioFunctionBuilder.BuildForRp2040();
        ...
        protected abstract DoubleWordRegister CreateStatusRegister();

        protected DoubleWordRegisterCollection CreateRegisters()
        {
