    ...
    public class RP2040SIO : RP2040PeripheralBase, IKnownSize
    {
        ...
        private void DefineRegisters()
        {
            ...
            Registers.GPIO_OUT.Define(this)
                .WithValueField(0, 30,
                    valueProviderCallback: _ => gpio.GetGpioStateBitmap(),
                    writeCallback: (_, value) => gpio.SetGpioBitmap(value, RpGpioFunction.SIO),
                    name: "GPIO_OUT")
                .WithReservedBits(30, 2);

            Registers.GPIO_OUT_SET.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpio.SetGpioBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_OUT_SET")
                .WithReservedBits(30, 2);

            Registers.GPIO_OUT_CLR.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpio.ClearGpioBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_OUT_CLR")
                .WithReservedBits(30, 2);

            Registers.GPIO_OUT_XOR.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpio.XorGpioBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_OUT_XOR")
                    .WithReservedBits(30, 2);

            Registers.GPIO_OE.Define(this)
                .WithValueField(0, 30, valueProviderCallback: _ => gpio.GetOutputEnableBitmap(),
                    writeCallback: (_, value) => gpio.SetOutputEnableBitmap(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_OE")
                .WithReservedBits(30, 2);

            Registers.GPIO_OE_SET.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpio.SetOutputEnableBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_SET")
                .WithReservedBits(30, 2);

            Registers.GPIO_OE_CLR.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpio.ClearOutputEnableBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_CLR")
                .WithReservedBits(30, 2);

            Registers.GPIO_OE_XOR.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpio.XorOutputEnableBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_XOR")
                .WithReservedBits(30, 2);
            ...
            Registers.GPIO_HI_OUT.Define(this)
                .WithValueField(0, 6,
                    valueProviderCallback: _ => gpioQspi.GetGpioStateBitmap(),
                    writeCallback: (_, value) => gpioQspi.SetGpioBitmap(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_OUT")
                .WithReservedBits(6, 26);

            Registers.GPIO_HI_OUT_SET.Define(this)
                .WithValueField(0, 6, FieldMode.Write,
                    writeCallback: (_, value) => gpioQspi.SetGpioBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_OUT_SET")
                .WithReservedBits(6, 26);

            Registers.GPIO_HI_OUT_CLR.Define(this)
                .WithValueField(0, 6, FieldMode.Write,
                    writeCallback: (_, value) => gpioQspi.ClearGpioBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_OUT_CLR")
                .WithReservedBits(6, 26);

            Registers.GPIO_HI_OUT_XOR.Define(this)
                .WithValueField(0, 6, FieldMode.Write,
                    writeCallback: (_, value) => gpioQspi.XorGpioBitset(value, RpGpioFunction.SIO),
            ...
            Registers.GPIO_HI_OE.Define(this)
                .WithValueField(0, 30, valueProviderCallback: _ => gpioQspi.GetOutputEnableBitmap(),
                    writeCallback: (_, value) => gpioQspi.SetOutputEnableBitmap(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_OE")
                .WithReservedBits(30, 2);

            Registers.GPIO_HI_OE_SET.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpioQspi.SetOutputEnableBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_SET")
                .WithReservedBits(30, 2);

            Registers.GPIO_HI_OE_CLR.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpioQspi.ClearOutputEnableBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_CLR")
                .WithReservedBits(30, 2);

            Registers.GPIO_HI_OE_XOR.Define(this)
                .WithValueField(0, 30, FieldMode.Write,
                    writeCallback: (_, value) => gpioQspi.XorOutputEnableBitset(value, RpGpioFunction.SIO),
                    name: "GPIO_HI_XOR")
                .WithReservedBits(30, 2);
